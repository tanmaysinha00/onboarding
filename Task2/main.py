...
reasons = {
    "Avoiding an outing plan.": ["Your car has a flat tire.",
    ...
    "Chilling on a Wednesday.": ["I am not feeling so well ",
                                 "I am vomiting copiously",
                                 "My wallet/phone/identity was stolen!",
                                 "Ugh, my car is in the shop and/or the G train is not running!",
                                 "There is a family/roommate/pet emergency",
                                 "My dog is throwing up"
                                 ],

    "Skiping a family function.": ["Have to pick up/drop someone to the airport/railway station. ",
                                   ...
                                   "I have got a stomach infection."
                                   ],

    "Buying a dog.": ["Dogs Give Us A Sense Of Purpose ",
    ...
    "Going for a party.": [" A party celebrates and formalizes the act of officially handing the house over to the homeowners. ",
    ...
    "Buying a new car.": ["Buying A  Car Saves Money ",
    ...
    "Going for a vacation.": ["My dogs been whining a lot lately. I think he's depressed and its time I take him on a road trip. ",
...
def question():
    ...
    return render_template("reason.html", message=message, question=question)
